...
import java.util.Scanner;
					...
					//accountMaster 상속
public class Woori extends AccountMaster {
	Scanner scanner = new Scanner(System.in);
	final public static String bankCode = "05";
