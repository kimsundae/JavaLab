...
public class StreamEx7 {
    public static void main(String[] args) {
        ...
        System.out.printf("%n4. 다중분할(성별 합격자, 100점 이상) %n");
        List<Student2> failedMaleStu2 = failedStuBySex.get(true).get(false);
        List<Student2> failedFemaleStu2 = failedStuBySex.get(false).get(false);

        for(Student2 s : failedMaleStu2) System.out.println(s);
        for(Student2 s : failedFemaleStu2) System.out.println(s);
    }
}
